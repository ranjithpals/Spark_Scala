...
object Stream_Stateful_wCount extends App {
  ...
  //Count the occurrences of each word using Stateful Transformation
  val finalRDD = rdd2.updateStateByKey(updateFunc)
